...
static const int STAKE_TARGET_SPACING = 60 * 2;
...
public:
    ...
    {
        // CRAZY: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // CRAZY: get transaction coin age
...
public:
    ...
    // CRAZY: block signature - signed by coin base txout[0]'s owner
    ...
    // CRAZY: two types of block: proof-of-work or proof-of-stake
    ...
    // CRAZY: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // CRAZY: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // CRAZY: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // CRAZY: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // CRAZY: block index flags
    enum  
    {
