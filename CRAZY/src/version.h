...
// Copyright (c) 2012-2013 The CRAZY developers
...
// CRAZY version - intended for display purpose only
#define CRAZY_VERSION_MAJOR       1
#define CRAZY_VERSION_MINOR       0
#define CRAZY_VERSION_REVISION    0
#define CRAZY_VERSION_BUILD       0

static const int CRAZY_VERSION =
                           1000000 * CRAZY_VERSION_MAJOR
                         +   10000 * CRAZY_VERSION_MINOR
                         +     100 * CRAZY_VERSION_REVISION
                         +       1 * CRAZY_VERSION_BUILD;

// CRAZY version - reference for code tracking
