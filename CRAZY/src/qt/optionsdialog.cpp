        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start CRAZY on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start CRAZY after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the CRAZY client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    QLabel *fee_help = new QLabel(tr("CRAZY Network Transaction fees will result in that amount being completely burned from the CRAZY moneysupply. Fees paid in a transaction are paid to no one"));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show CRAZY addresses in the transaction list"));
