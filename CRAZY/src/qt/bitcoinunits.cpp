...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CRAZY");
    case mBTC: return QString("mCRAZY");
    case uBTC: return QString::fromUtf8("μCRAZY");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("CRAZY");
    case mBTC: return QString("Milli-CRAZY (1 / 1,000)");
    case uBTC: return QString("Micro-CRAZY (1 / 1,000,000)");
    default: return QString("???");
    }
}
