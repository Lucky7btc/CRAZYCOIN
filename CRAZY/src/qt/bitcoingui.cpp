 ...
 * The CRAZY Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("CRAZY Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/CRAZY_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CRAZY address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/CRAZY_tooltip"), tr("&About CRAZY"), this);
    aboutAction->setToolTip(tr("Show information about CRAZY"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for CRAZY"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/CRAZY_tooltip"), tr("Show/Hide &CRAZY"), this);
    toggleHideAction->setToolTip(tr("Show or hide the CRAZY window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/CRAZY_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/CRAZY_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/CRAZY_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CRAZY client"));
    trayIcon->setIcon(QIcon(":/icons/CRAZY_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CRAZY network", "", count));
}
